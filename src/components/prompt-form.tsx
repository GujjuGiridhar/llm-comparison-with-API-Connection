      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            />
            <Button type="submit" disabled={isLoading} className="w-full bg-accent-foreground text-accent hover:bg-accent-foreground/90">
              {isLoading ? (
                ...
                <>
                  Generate Responses <Send className="ml-2" />
                </>
              )}
            </Button>
          </form>
